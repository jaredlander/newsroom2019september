...
params:
    className: "R at Bloomberg"
    repoName: "newsroom2019september"
...
Paste ``r sprintf('https://github.com/%s/%s', params$repoOwner, params$repoName)``^[Or `git@github.com:nyhackr/cbs2019fall.git` for ssh.] in the `Repository URL` field.
